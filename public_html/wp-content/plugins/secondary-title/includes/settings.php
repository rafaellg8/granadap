                     ...
                     <tr id="row-title-format">
                        ...
                        <td>
                           ...
                           <p class="description note">
                              <?php
                                 echo sprintf(__('<b>Note:</b> To style the output, use <a href="%s" title="See an explanation on w3schools.com" target="_blank">HTML style attributes</a>, e.g.:<br />%s', "secondary-title"), "https://www.w3schools.com/tags/att_global_style.asp", '<code title="' . __("Add code to title format input", "secondary-title") . '">' . esc_attr('<span style="color:#ff0000;font-size:14px;">%secondary_title%</span>') . "</code>");
                              ?>
                           </p>
                        </td>
                     </tr>
                     ...
                     <table class="form-table">
                        <tr>
                           ...
                           <td>
                              ...
                              <p class="description">
                                 <?php _e("Only displays the secondary title if the post is a main post and <strong>not</strong> within a widget etc.", "secondary-title"); ?>
                              </p>
                           </td>
                        </tr>
                              ...
                              <div class="post-types">
                                 <?php
                                    ...
                                    foreach($post_types as $post_type) {
                                       ...
                                       $label = sprintf(_n("1 post", "%s posts", $post_type_posts_count, "secondary-title"), $post_type_posts_count);
                                       ?>
                                       <p class="post-type">
                              ...
                              <div class="list">
                                 <?php
                                    ...
                                    foreach($categories as $category) {
                                       ...
                                       ?>
                                       <div class="list-item" title="<?php echo sprintf(__("There are %s posts in %s", "secondary-title"), $category->count, $category->name); ?>">
                                 ...
                                 <div class="list-actions">
                                    ...
                                    <span id="unselect-all-categories-container" hidden>
                                       <a href="#" id="unselect-all-categories">
                                          <?php _e("Unselect all", "secondary-title"); ?>
                                       </a>
                                    </span>
                                 </div>
                                 <p class="description">
