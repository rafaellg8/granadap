<?php
   ...
   function init_secondary_title_admin_posts() {
      ...
      <input type="text" size="30" id="secondary-title-input" class="secondary-title-input" placeholder="<?php _e("Enter secondary title here", "secondary-title"); ?>" name="secondary_post_title" hidden value="<?php echo get_post_meta(get_the_ID(), "_secondary_title", true); ?>"/>
      <?php
      return true;
   }
   ...
   function secondary_title_change_column_position() {
      ...
      <script type="text/javascript">
          jQuery(document).ready(function () {
              var secondaryTitleHeadCell, primaryTitleHeadCell, posts, post;
